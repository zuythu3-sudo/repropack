...
Command-line package for [ReproPack](../../README.md), a local tool that turns a
failing command into a reviewable, redacted `.repropack.json` diagnostic report.
...
export. The project is licensed under Apache-2.0; see the repository's root
license and security policy for details.
